h22573
s 00001/00000/00498
d D 1.3 02/06/26 17:52:34 ytse 3 2
c Backup after fixing bug
e
s 00098/00029/00400
d D 1.2 02/06/26 14:40:46 ytse 2 1
c Backup
e
s 00429/00000/00000
d D 1.1 02/06/24 17:20:52 ytse 1 0
c date and time created 02/06/24 17:20:52 by ytse
e
u
U
f e 0
...
E 2
    ...
    for (i=0; i<progCnt; i++) {
D 2
        if (prog[i].schVbvLevel < minVbvLevel) {
            minVbvLevel = prog[i].schVbvLevel;
E 2
I 2
...
D 2
                pProg->schLeftBytes = pProg->leftBytes;
                pProg->schDecDts = pProg->decDts;
E 2
I 2
...
D 2
            for (i=0; i<tblPerSchWin; i++, schTblIdx++, schCurTime+=tblTime) {
E 2
I 2
...
D 2
                        pStat->dptTime = schCurTime;	// Note: not accurate!
