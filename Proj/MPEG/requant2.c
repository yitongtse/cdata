// This program is used to study how to response to negative comments from
// patent reviewer
...
// Simple requant - inter
int requantSimple(int QF1, int qs1, int qs2)
{
    int scale = 13;
    return shftTrunc(QF1 * (qs2 << scale) / qs2 + (scale/2), scale);
}
