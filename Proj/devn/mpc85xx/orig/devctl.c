...
int mpc_devctl (void *hdl, int dcmd, void *data, size_t size, union _io_net_dcmd_ret_cred *ret_cred)
		...
		case	DCMD_IO_NET_CHANGE_MCAST:
			if (cfg->flags & NIC_FLAG_MULTICAST) {
                ...
                {   // easy multicast
                    ...
                    struct _io_net_msg_mcast *mcast = (io_net_msg_join_mcast_t *)data;
