...
static const char rcsid[] = "@(#)$Id: fils.c,v 1.11 2002/09/07 02:49:49 xtang Exp $";
#endif
...
#ifdef __QNXNTO__
	fprintf(stderr, "ipfstate_dead() is not implemented on this platform\n");
	return;
#else
	void *rules[2][2];
...
# else
			printw(" %7llu %9llu", (unsigned long long) tp->st_pkts,
				(unsigned long long) tp->st_bytes);
# endif
#else
