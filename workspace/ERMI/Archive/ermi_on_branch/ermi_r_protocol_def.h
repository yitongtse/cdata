...
#define ERRP_DFL_CONN_TIME        120 /* seconds */
...
typedef struct ermi_r_master_ {
    ...
    ipaddrtype             signalling_ip;
    ipaddrtype             alt_signalling_ip;
} ermi_r_master_t;
...
struct ermi_r_neighbor_ {
    ...
    /* ERRP PARAM */
    struct rfgw_video_server_group_ *server_group;
    // void * (*errp_get_qam_param)(struct ermi_r_neighbor_ *nbr, uint param_type, void **param_value);
    // void * (*errp_set_qam_param)(struct ermi_r_neighbor_ *nbr, uint param_type, void *param_value);
