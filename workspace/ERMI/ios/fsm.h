/* $Id: fsm.h,v 1.1 2010/10/01 17:41:16 ytse Exp ytse $
 * $Source: /Users/ytse/work/ermi/ios/RCS/fsm.h,v $
 *------------------------------------------------------------------
 * fsm.h -- General Purpose Finite State Machine Driver
 *
 *      March 4, 1992 - Wayne Clark
 *
 *      Copyright (c) 1992-2000, 2005-2006 by cisco Systems, Inc.
 *      All Rights Reserved
 *------------------------------------------------------------------
 */
 ...
 */
extern short fsm_execute_lite(char *, const fsm_t *, unsigned char *,
			      unsigned char, void *, int, int, boolean);
